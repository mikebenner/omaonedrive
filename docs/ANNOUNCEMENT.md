...
select **Refresh storage** or **Verify sync** — plus a single storage retry
when you open the panel onto a stale failed check — and the plugin never
reads or stores your refresh token.
